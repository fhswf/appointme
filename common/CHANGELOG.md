...
* Adjust module resolution by adding `.js` extensions to i18n imports and Jest module mapping. ([b7b2892](https://github.com/fhswf/appointme/commit/b7b28924c6fd439bbbf24b176395a23a0f14c977))
...
* **build:** fix CI build ([9100da1](https://github.com/fhswf/appointme/commit/9100da140dde9f2db6b47753e6a4e69a6df4c9d9))
* **build:** fix CI build on GitHub ([57e0865](https://github.com/fhswf/appointme/commit/57e0865da08096acaf5c8b90c10632f502f37ee3))
* **common:** fix IntervalSet constructor ([d387b1d](https://github.com/fhswf/appointme/commit/d387b1dbd0031f68c713eefb483b8e83c0dda513))
* import issue in localization files ([354739b](https://github.com/fhswf/appointme/commit/354739b7df6388cdd30d5db15ee80b1566df2a46))
* improve readability ([7613720](https://github.com/fhswf/appointme/commit/7613720c7544cd889ab63748dfddd46344a3a10d))
* improve readability ([00553c7](https://github.com/fhswf/appointme/commit/00553c7cc8fe7208735620935f6aece86759510a))
* improve readability ([309315f](https://github.com/fhswf/appointme/commit/309315f78faf992bf88a6752b9966adbc934b6b8))
...
* rebranding ([4f4ee0f](https://github.com/fhswf/appointme/commit/4f4ee0ff19e112e7062032ef789db35d38f2e56a))
...
* **test:** timezone for tests ([1e37226](https://github.com/fhswf/appointme/commit/1e37226175485b14818bdcab3cdf33e85bc4b08b))
* **test:** unit tests ([372ec93](https://github.com/fhswf/appointme/commit/372ec934fc954cf78fe5bf00612da733fceaf3d7))
...
* Add French, Italian, Japanese, Korean, Chinese, and Spanish locales and update i18n integration. ([4525680](https://github.com/fhswf/appointme/commit/4525680146bce9d0e40d7392548ceb0ac3f6de17))
...
* Add new localization strings for user profile management in French, Italian, German, and Spanish. ([d60c4ec](https://github.com/fhswf/appointme/commit/d60c4ecfbd71ffed78a735c6ae1db0fc9dd2d8f0))
...
* **event type:** add min/max timespan for events, add maximum number of events per day ([2c69283](https://github.com/fhswf/appointme/commit/2c692837bc3c7985d1490bcacb4826e0766064e9))
* **event type:** remove deprecated fields ([7fb4886](https://github.com/fhswf/appointme/commit/7fb4886ac0dc6b6a453c9ab204ce3d5db916d800))
...
* introduce AuthProvider for centralized authentication and streamline root routing to use `/` instead of `/app`. ([3566922](https://github.com/fhswf/appointme/commit/35669223a302fd0f98880b1aab7321093b4e46fe))
