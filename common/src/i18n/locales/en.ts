...
export const en = {
    ...
    "Define Custom": "Define Custom",
    "Use Standard": "Use Standard",
    "Standard + Extra": "Standard + Extra",
    "Standard + Constraints": "Standard + Constraints",
...
We use Sentry to collect anonymous telemetry data and error reports to improve the application stability.`,
    ...
    "Restricted to Students": "Restricted to Students",
    "Settings exported successfully": "Settings exported successfully",
    "Failed to export settings": "Failed to export settings",
    "Are you sure you want to import settings? This will overwrite your current profile and events.": "Are you sure you want to import settings? This will overwrite your current profile and events.",
    ...
    "Download your settings and events as a JSON file.": "Download your settings and events as a JSON file.",
    "Export Data": "Export Data",
    "Import Settings": "Import Settings",
    "Restore your settings from a JSON file. This will overwrite existing data.": "Restore your settings from a JSON file. This will overwrite existing data.",
    "Select File": "Select File",
    "Online Meeting": "Online Meeting",
    "You are logged in via your Learning Management System. Please use the specific booking links provided in your course to book appointments.": "You are logged in via your Learning Management System. Please use the specific booking links provided in your course to book appointments.",
    "Logout": "Logout",
    "MyProvider": "MyProvider",
    "confirmationText_male": "You booked an {{event}} with {{name}} appointment on {{date}} at {{time}}.",
