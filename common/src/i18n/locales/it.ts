...
export const it = {
    ...
    "Add": "Aggiungi",
    "Close": "Chiudi",
    "Choose calendars in which appointments are created.": "Scegli i calendari in cui vengono creati gli appuntamenti.",
    "Email (Optional)": "Email (Opzionale)",
    "Enter your CalDav server details to connect your calendar.": "Inserisci i dettagli del tuo server CalDav per collegare il tuo calendario.",
    "Failed to add account. Please check your credentials and server URL.": "Impossibile aggiungere l'account. Controlla le tue credenziali e l'URL del server.",
...
Utilizziamo Sentry per raccogliere dati di telemetria anonimi e segnalazioni di errori per migliorare la stabilità dell'applicazione.`,
    ...
    "no_upcoming_appointments": "Nessun appuntamento imminente trovato.",
