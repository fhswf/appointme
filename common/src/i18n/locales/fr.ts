...
export const fr = {
    "Notice": "Notice",
    "No slots available for the selected period.": "Aucun créneau disponible pour la période sélectionnée.",
    "welcome_back": "Bon retour",
    "login_subtitle": "Veuillez vous connecter pour continuer.",
    "login_tos_prefix": "En vous connectant, vous acceptez nos",
    ...
    "Available Meeting Types": "Types de réunion disponibles",
    "Please select a meeting type to view availability.": "Veuillez sélectionner un type de réunion pour voir les disponibilités.",
    "All": "Tous",
    "No public events found.": "Aucun événement public trouvé.",
    ...
    "Add": "Ajouter",
    "Close": "Fermer",
    "Choose calendars in which appointments are created.": "Choisissez les calendriers dans lesquels les rendez-vous sont créés.",
    "Email (Optional)": "E-mail (Facultatif)",
    "Enter your CalDav server details to connect your calendar.": "Entrez les détails de votre serveur CalDav pour connecter votre calendrier.",
    "Failed to add account. Please check your credentials and server URL.": "Impossible d'ajouter le compte. Veuillez vérifier vos identifiants et l'URL du serveur.",
    ...
    "Copy Standard Availability": "Copier la disponibilité standard",
    "Overwrite current availability with standard?": "Remplacer la disponibilité actuelle par la standard ?",
    "Profile": "Profil",
    "about": "À propos",
...
Nous utilisons Sentry pour collecter des données télémétriques anonymes et des rapports d'erreurs afin d'améliorer la stabilité de l'application.`,
    ...
    "no_upcoming_appointments": "Aucun rendez-vous à venir trouvé.",
    ...
    "Student Only": "Étudiants uniquement",
    "Restricted to Students": "Réservé aux étudiants",
    ...
    "Are you sure you want to import settings? This will overwrite your current profile and events.": "Êtes-vous sûr de vouloir importer des paramètres ? Cela écrasera votre profil et vos événements actuels.",
    ...
    "Download your settings and events as a JSON file.": "Téléchargez vos paramètres et événements sous forme de fichier JSON.",
    "Export Data": "Exporter les données",
    "Import Settings": "Importer les paramètres",
    "Restore your settings from a JSON file. This will overwrite existing data.": "Restaurez vos paramètres à partir d'un fichier JSON. Cela écrasera les données existantes.",
    "Select File": "Sélectionner un fichier",
    "Online Meeting": "Réunion en ligne",
    "You are logged in via your Learning Management System. Please use the specific booking links provided in your course to book appointments.": "Vous êtes connecté via votre système de gestion de l'apprentissage. Veuillez utiliser les liens de réservation spécifiques fournis dans votre cours pour prendre rendez-vous.",
